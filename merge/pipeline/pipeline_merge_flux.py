...
from merge.pipeline.merge_transformer_flux import MERGEFluxTransformerModel
...
class MERGEFluxPipeline(
    ...
    def __init__(
        ...
        text_encoder_2: T5EncoderModel,
        tokenizer_2: T5TokenizerFast,
        transformer: MERGEFluxTransformerModel,
    ):
        super().__init__()
    ...
    def merge_process(
        ...
        num_channels_latents = self.transformer.merge_converters.config.in_channels // 8
        ...
        # handle guidance
        if self.transformer.merge_converters.config.guidance_embeds:
