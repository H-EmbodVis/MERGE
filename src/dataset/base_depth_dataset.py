...
class BaseDepthDataset(Dataset):
    def __init__(
        ...
        rgb_transform=default_rgb_transform,  #  [0, 255] -> [-1, 1],
        **kwargs,
    ) -> None:
        super().__init__()
        self.mode = mode
        ...
        #eval inf
        self.alignment_max_res = None
        self.processing_res = None
    ...
    def _get_data_item(self, index):
        ...
        #return  the range of depth value of the dataset
        other = {
            "index": index,
